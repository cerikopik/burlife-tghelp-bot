    ...
    try:
        ...
        # elif является частью той же конструкции if
            ...
            preset_message = (
                ...
                "Просто отправьте боту фотографию 🖼️, например, вашего пропуска или удостоверения о проверке знаний, где будут четко видны ваши Имя и Фамилия.\n"
                "‼️Ни в коем случае не присылайте фото вашего паспорта или водительского удостоверения."
            )
            await context.bot.send_message(
                chat_id=user_id,
                text=preset_message
